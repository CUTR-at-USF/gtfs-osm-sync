 ...
 */
public class MainForm_New extends javax.swing.JFrame implements PropertyChangeListener {
        ...
        */
        ...
        try {
            ...
            if (!_operatorName.isEmpty() && !_operatorNameAbbreviate.isEmpty() && !_fileDir.isEmpty()) {
                ...
                progressMonitor = new ProgressMonitor(MainForm_New.this, "Comparing GTFS and OSM data", "", 0, 100);
                progressMonitor.setProgress(0);
                compareButton.setEnabled(false);
                compareTask = new CompareData(progressMonitor, taskOutput);
                task = compareTask;
...
//                }
    ...
    private void revertButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_revertButtonActionPerformed
        try {
            ...
            progressMonitor = new ProgressMonitor(MainForm_New.this, "Reverting Openstreetmap changeset", "", 0, 100);
            progressMonitor.setProgress(0);
