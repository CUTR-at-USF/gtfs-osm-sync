 ...
 */
public class MainForm3 extends javax.swing.JFrame implements PropertyChangeListener {
    ...
    private void compareButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_compareButtonActionPerformed
        ...
        try {
            ...
            if (!_operatorName.isEmpty() && !_operatorNameAbbreviate.isEmpty() && !_fileDir.isEmpty()) {
                ...
                progressMonitor = new ProgressMonitor(MainForm3.this, "Comparing GTFS and OSM data", "", 0, 100);
    ...
    private void revertButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_revertButtonActionPerformed
        try {
            ...
            progressMonitor = new ProgressMonitor(MainForm3.this, "Reverting Openstreetmap changeset", "", 0, 100);
            progressMonitor.setProgress(0);
